...
public class UpstreamsCalculator extends TimeFrameCalculator implements Calculator {
	...
	private HashMap<String, Double> RequestsRatePerUpstream = new HashMap<>();
	private HashMap<String, Double> RequestsPerUpstream = new HashMap<>();
	private HashMap<String, Double> ResponsesRatePerUpstream = new HashMap<>();
	private HashMap<String, Double> ResponsesPerUpstream = new HashMap<>();
	private HashMap<String, Double> Responses1xxRatePerUpstream = new HashMap<>();
	private HashMap<String, Double> Responses1xxPerUpstream = new HashMap<>();
	private HashMap<String, Double> Responses2xxRatePerUpstream = new HashMap<>();
	private HashMap<String, Double> Responses2xxPerUpstream = new HashMap<>();
	private HashMap<String, Double> Responses3xxRatePerUpstream = new HashMap<>();
	private HashMap<String, Double> Responses3xxPerUpstream = new HashMap<>();
	private HashMap<String, Double> Responses4xxRatePerUpstream = new HashMap<>();
	private HashMap<String, Double> Responses4xxPerUpstream = new HashMap<>();
	private HashMap<String, Double> Responses5xxRatePerUpstream = new HashMap<>();
